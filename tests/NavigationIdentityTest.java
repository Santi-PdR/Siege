...
public final class NavigationIdentityTest {
    ...
    public static void main(String[] args) {
        ...
        expect("uy.santipdr.siege.client.SiegeRecruitBriefingScreen", SiegeNavigationModel.Section.OPERATIONS, "RCT", "RECRUIT BRIEFING");
        expect("uy.santipdr.siege.client.SiegeKnowledgeScreen", SiegeNavigationModel.Section.KNOWLEDGE, "ENC", "SERVER ENCYCLOPEDIA");
        expect("uy.santipdr.siege.client.SiegeRaceAtlasScreen", SiegeNavigationModel.Section.KNOWLEDGE, "RCE", "RACE ATLAS");
        expect("uy.santipdr.siege.client.SiegeProgressionMapScreen", SiegeNavigationModel.Section.KNOWLEDGE, "PRG", "PROGRESSION MAP");
        expect("uy.santipdr.siege.client.SiegeThreatBoardScreen", SiegeNavigationModel.Section.INTEL, "THR", "THREAT BOARD");
        expect("uy.santipdr.siege.client.SiegeMediaRoomScreen", SiegeNavigationModel.Section.MEDIA, "AV", "MEDIA ROOM");
        ...
        System.out.println("SIEGE 4.00 recruit/races/progression/threat/media plus legacy identities passed");
    }
