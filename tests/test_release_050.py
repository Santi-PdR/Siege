...
# Briefing remains a newcomer path, not a second encyclopedia. The title can evolve,
# but it must remain clearly identified and must use the runtime version rather than a stale release literal.
...
assert '"BRIEFING // " + SiegeRuntimeStatus.version()' in BRIEF or "PRIMEROS PASOS" in BRIEF
