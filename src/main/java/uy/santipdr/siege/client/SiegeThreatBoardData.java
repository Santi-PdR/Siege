...
public final class SiegeThreatBoardData {
    ...
    private static final List<Threat> THREATS = List.of(
            new Threat("intel", "UNIDADES DOCUMENTADAS", "DOCUMENTED UNITS",
                    "Dossiers de UNIT, ADVANCED, TANK, BOSS, ELITE, SUPER-UNIT y UNKNOWN. UNKNOWN permanece cuando falta información fiable.",
                    "Dossiers for UNIT, ADVANCED, TANK, BOSS, ELITE, SUPER-UNIT and UNKNOWN. UNKNOWN remains when reliable information is missing.",
                    Severity.HIGH, "", true),
            ...
            new Threat("factions", "FACCIONES / ENEMIGOS", "FACTIONS / ENEMIES",
                    "Pueden adaptarse, sabotear tecnología o atacar infraestructura; proteger rutas de escape y variar métodos.",
