...
/** Non-personal progression map built from the server encyclopedia. */
    ...
    private static final List<Track> TRACKS = List.of(
            new Track("core", "PROGRESIÓN GENERAL", "GENERAL PROGRESSION",
                    ...
                    List.of(
                            ...
                            n("race", "Identificar progresión racial", "Identify race progression",
            ...
            new Track("advanced", "PROGRESIÓN AVANZADA", "ADVANCED PROGRESSION",
                    "Sistemas que suelen aparecer cuando el jugador ya maneja la base del servidor.",
                    "Systems that usually matter after the player understands the server basics.",
                    List.of(
                            ...
                            n("relics", "Reliquias", "Relics", "Investigar antes de equipar, vender o extraer.", "Research before equipping, selling or extracting.", Status.CONFIRMED, "relic-basics"),
